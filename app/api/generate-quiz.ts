...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        {
            "question": "Your second question based on {topic} here.",
            "options": {
                "A": "Option A",
                "B": "Option B",
                "C": "Option C",
        ...
        {
            "question": "Your third question based on {topic} here.",
            "options": {
                "A": "Option A",
                "B": "Option B",
                "C": "Option C",
        ...
        {
            "question": "Your fourth question based on {topic} here.",
            "options": {
                "A": "Option A",
                "B": "Option B",
                "C": "Option C",
        ...
        {
            "question": "Your fifth question based on {topic} here.",
            "options": {
                "A": "Option A",
                "B": "Option B",
                "C": "Option C",
